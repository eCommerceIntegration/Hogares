...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.Empleado}.
 */
@RestController
@RequestMapping("/api")
public class EmpleadoResource {
    ...
    public ResponseEntity<Empleado> updateEmpleado(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, empleado.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Empleado> partialUpdateEmpleado(
            ...
            .map(
                existingEmpleado -> {
                    if (empleado.getEmpleadoId() != null) {
                        existingEmpleado.setEmpleadoId(empleado.getEmpleadoId());
                    }
                    ...
                    if (empleado.getPhoneNumber() != null) {
                        existingEmpleado.setPhoneNumber(empleado.getPhoneNumber());
                    }
                    if (empleado.getHireDate() != null) {
                        existingEmpleado.setHireDate(empleado.getHireDate());
                    }
                    if (empleado.getSalary() != null) {
                        existingEmpleado.setSalary(empleado.getSalary());
                    }
                    if (empleado.getCommissionPct() != null) {
                        existingEmpleado.setCommissionPct(empleado.getCommissionPct());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, empleado.getId())
        );
    }
