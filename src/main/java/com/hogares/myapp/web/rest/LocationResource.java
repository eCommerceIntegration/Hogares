...
import com.hogares.myapp.repository.LocationRepository;
import com.hogares.myapp.service.LocationService;
...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.Location}.
 */
@RestController
@RequestMapping("/api")
