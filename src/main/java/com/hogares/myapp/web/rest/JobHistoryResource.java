...
import com.hogares.myapp.repository.JobHistoryRepository;
import com.hogares.myapp.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
