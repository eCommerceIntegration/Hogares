...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.Pais}.
 */
@RestController
@RequestMapping("/api")
public class PaisResource {
     ...
     */
    @PutMapping("/pais/{id}")
    public ResponseEntity<Pais> updatePais(@PathVariable(value = "id", required = false) final String id, @RequestBody Pais pais)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pais.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Pais> partialUpdatePais(@PathVariable(value = "id", required = false) final String id, @RequestBody Pais pais)
        throws URISyntaxException {
        ...
        Optional<Pais> result = paisRepository
            ...
            .map(
                existingPais -> {
                    if (pais.getPaisName() != null) {
                        existingPais.setPaisName(pais.getPaisName());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pais.getId()));
    }
