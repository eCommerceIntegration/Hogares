...
import com.hogares.myapp.domain.Department;
import com.hogares.myapp.repository.DepartmentRepository;
import com.hogares.myapp.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.Department}.
 */
@RestController
@RequestMapping("/api")
