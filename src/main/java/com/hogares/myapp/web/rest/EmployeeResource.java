...
import com.hogares.myapp.domain.Employee;
import com.hogares.myapp.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.hogares.myapp.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
